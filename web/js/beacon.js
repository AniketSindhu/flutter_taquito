(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ...
    ? define(["exports", "@airgap/beacon-sdk", "@taquito/taquito"], factory)
    : ((global =
        typeof globalThis !== "undefined" ? globalThis : global || self),
      factory(
        (global.taquitoBeaconWallet = {}),
        global.beacon,
        global.taquito
      ));
})(this, function (exports, beaconSdk, taquito) {
  "use strict";
  ...
  var MissingRequiredScopes = /** @class */ (function () {
    function MissingRequiredScopes(requiredScopes) {
      ...
      this.message =
        "Required permissions scopes were not granted: " +
        requiredScopes.join(",");
    }
  ...
  var BeaconWallet = /** @class */ (function () {
    ...
    BeaconWallet.prototype.validateRequiredScopesOrFail = function (
      permissionScopes,
      requiredScopes
    ) {
      var e_1, _a;
      ...
      try {
        for (
          var permissionScopes_1 = __values(permissionScopes),
            permissionScopes_1_1 = permissionScopes_1.next();
          !permissionScopes_1_1.done;
          permissionScopes_1_1 = permissionScopes_1.next()
        ) {
        ...
        try {
          if (
            permissionScopes_1_1 &&
            !permissionScopes_1_1.done &&
            (_a = permissionScopes_1.return)
          )
            _a.call(permissionScopes_1);
        } finally {
    ...
    BeaconWallet.prototype.getPKH = function () {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.client.getActiveAccount()];
            case 1:
              account = _a.sent();
              if (!account) {
    ...
    BeaconWallet.prototype.mapTransferParamsToWalletParams = function (params) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            case 0:
              return [4 /*yield*/, this.client.showPrepare()];
            case 1:
              _c.sent();
              _c.label = 2;
            case 2:
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                taquito.createTransferOperation(
    ...
    BeaconWallet.prototype.mapOriginateParamsToWalletParams = function (
      params
    ) {
      return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                taquito.createOriginationOperation(
                  this.formatParameters(walletParams)
                ),
              ];
            case 7:
        ...
        return __generator(this, function (_c) {
          switch (_c.label) {
            ...
            case 6:
              ...
              return [
                4 /*yield*/,
                taquito.createSetDelegateOperation(
                  this.formatParameters(walletParams)
                ),
              ];
            case 7:
    ...
    BeaconWallet.prototype.removeDefaultParams = function (
      params,
      operatedParams
    ) {
          ...
          switch (_a.label) {
            ...
            case 1:
              ...
              this.validateRequiredScopesOrFail(permissions, [
                beaconSdk.PermissionScope.OPERATION_REQUEST,
              ]);
              return [
                4 /*yield*/,
                this.client.requestOperation({ operationDetails: params }),
              ];
            case 2:
    ...
    BeaconWallet.prototype.clearActiveAccount = function () {
      return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
          switch (_a.label) {
            case 0:
              return [4 /*yield*/, this.client.setActiveAccount()];
            case 1:
              _a.sent();
              return [2 /*return*/];
          }
